...
import {
  BookOpen, ChevronRight, ExternalLink, Search,
...
const CATEGORIES = [
  ...
  { id:'investing',      label:'Investing',            icon:TrendingUp,  color:TEAL    },
...
const RESOURCES = [
  // ── BUDGETING ──────────────────────────────────────
  {
    ...
    tags:['budgeting','zero-based','app'],
  },
  {
    id:'mint', category:'budgeting', type:'Tool',
    name:'Monarch Money',
    ...
    tags:['budgeting','tracking','net worth'],
  },
  {
    ...
    tags:['budgeting','free','government'],
  },
  {
    id:'50-30-20', category:'budgeting', type:'Guide',
  ...
  // ── DEBT & CREDIT ──────────────────────────────────
  {
    ...
    tags:['credit','free','government','report'],
  },
  {
    ...
    tags:['credit','free','monitoring','score'],
  },
  {
    ...
    tags:['debt','counseling','nonprofit','free'],
  },
  {
    id:'studentaid', category:'debt', type:'Tool',
    name:'Federal Student Aid — Income-Driven Repayment',
    ...
    tags:['debt','student loans','repayment','government'],
  },
  {
  ...
  // ── INVESTING ──────────────────────────────────────
  {
    ...
    tags:['investing','index funds','education','free'],
  },
  {
    ...
    tags:['investing','government','SEC','education'],
  },
  {
    id:'finra-brokercheck', category:'investing', type:'Tool',
    ...
    tags:['investing','advisor','verification','free'],
  },
  {
    ...
    tags:['investing','ETF','research'],
  },
  {
    id:'personalfinance-wiki', category:'investing', type:'Guide',
    ...
    tags:['investing','budgeting','framework','free'],
  },
  ...
  // ── INSURANCE ──────────────────────────────────────
  {
    ...
    tags:['insurance','government','comparison'],
  },
  {
    ...
    tags:['insurance','comparison','quotes','life'],
  },
  {
    ...
    tags:['insurance','health','ACA','government'],
  },
  {
    id:'disabilityquotes', category:'insurance', type:'Tool',
    name:'DI Quote (Disability Insurance Quotes)',
    ...
    url:'https://www.diaquote.com',
    tags:['insurance','disability','quotes'],
  },
  ...
  },
  {
    ...
    tags:['estate','healthcare directive','free','government'],
  },
  {
    ...
    tags:['estate','attorney','elder law'],
  },

  // ── RETIREMENT ──────────────────────────────────────
  {
    id:'ssa-myaccount', category:'retirement', type:'Tool',
    name:'SSA My Account',
    ...
    tags:['retirement','social security','government','free'],
  },
  {
    ...
    tags:['retirement','calculator','withdrawal','free'],
  },
  {
  ...
  },
  {
    ...
    tags:['retirement','IRA','401k','government'],
  },
  ...
  // ── MAJOR PURCHASES ──────────────────────────────────────
  {
    ...
    tags:['home','mortgage','buying','government'],
  },
  {
    ...
    url:'https://www.edmunds.com/tmv.html',
    tags:['car','pricing','negotiation'],
  },
  {
    ...
    tags:['car','used','history','research'],
  },
  {
    id:'nytrentbuy', category:'majorpurchases', type:'Tool',
    ...
    tags:['home','rent vs buy','calculator'],
  },
  {
    ...
    tags:['savings','HYSA','rates'],
  },

  // ── LIFE EVENTS ──────────────────────────────────────
  {
    id:'careeronestop', category:'lifeevents', type:'Tool',
    name:'CareerOneStop — Unemployment Finder',
    ...
    tags:['job loss','unemployment','government'],
  },
  {
    ...
    tags:['life events','health insurance','ACA'],
  },
  {
    ...
    url:'https://institutedfa.com/finding-a-cdfa/',
    tags:['divorce','financial planning','specialist'],
  },
  {
    ...
    url:'https://www.savingforcollege.com/529-plans/',
    tags:['baby','college','529','savings'],
  },
  ...
  // ── BOOKS ──────────────────────────────────────
  {
    ...
    tags:['books','debt','budgeting','beginner'],
  },
  {
    id:'psychology-money', category:'books', type:'Book',
    ...
    tags:['books','mindset','investing','behavior'],
  },
  {
    ...
    tags:['books','investing','index funds','beginner'],
  },
  {
    ...
    tags:['books','fundamentals','beginner','classic'],
  },
  {
    ...
    tags:['books','young adults','automation','investing','beginner'],
  },
  {
    id:'millionaire-nextdoor', category:'books', type:'Book',
    ...
    tags:['books','wealth','mindset','research'],
  },
  ...
  // ── PODCASTS ──────────────────────────────────────
  {
    ...
    tags:['podcasts','economics','education','free'],
  },
  {
    ...
    url:'https://www.fool.com/podcasts/motley-fool-money/',
    tags:['podcasts','investing','markets'],
  },
  {
    id:'bigger-pockets-money', category:'podcasts', type:'Podcast',
    ...
    url:'https://www.biggerpockets.com/podcasts/money',
    tags:['podcasts','FIRE','financial independence','investing'],
  },
  {
    ...
    tags:['podcasts','financial independence','real estate','FIRE'],
  },
  {
    ...
    tags:['podcasts','FIRE','financial independence','frugality'],
  },

  // ── GOVERNMENT ──────────────────────────────────────
  {
    id:'irs-gov', category:'government', type:'Tool',
    name:'IRS.gov',
    ...
    tags:['government','tax','official'],
  },
  {
    id:'sec-gov', category:'government', type:'Tool',
    ...
    tags:['government','investing','SEC','fraud'],
  },
  {
    ...
    tags:['government','consumer rights','complaints','education'],
  },
  {
    ...
    tags:['government','financial literacy','education','free'],
  },
  {
    id:'dol-gov', category:'government', type:'Tool',
    name:'Department of Labor — Benefits & Retirement',
    ...
    tags:['government','401k','retirement','ERISA'],
  },
];
...
export default function Resources() {
  ...
  const filtered = RESOURCES.filter(r => {
    ...
    const matchQuery = !q || r.name.toLowerCase().includes(q) || r.desc.toLowerCase().includes(q) || r.tags.some(t => t.includes(q));
  ...
  return (
    <div style={{ minHeight:'100vh', background:BG, fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div style={{ display:'flex', gap:'1.5rem', padding:'2rem 2.5rem', maxWidth:1080, margin:'0 auto' }}>
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          {filtered.length === 0 ? (
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'0.75rem' }}>
              {filtered.map(r => {
                const typeStyle = TYPE_COLORS[r.type] || TYPE_COLORS.Tool;
                ...
                return (
                  ...
                  >
                    ...
                    <ExternalLink size={15} color='#d1d5db' style={{ flexShrink:0, marginTop:3 }}/>
                  </a>
                );
              })}
            </div>
